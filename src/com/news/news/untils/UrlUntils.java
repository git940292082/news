...
public class UrlUntils {
	...
	public static String getLuckUrl(String name) {
		...
		String url = "http://web.juhe.cn:8080/constellation/getAll?consName=" + name
				+ "&type=today&key=517a0113e3ec1629c2aa7eb231a617cf";
		return url;

	}

	public static String getNewsUrl(String NewsName) {
		String url = "http://v.juhe.cn/toutiao/index?type=" + NewsName + "&key=9ec8d66e41b5953b4c6ebfe400e21434";
		return url;
	}
